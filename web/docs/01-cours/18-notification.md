...
Pour la mise en place de Firebase, vous devez suivre les étapes décrites **[ici (Configuration de Firebase)](../04-laboratoires/Laboratoire%205.1/a-firebase_setup.md)**.
