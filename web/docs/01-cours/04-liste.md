...
- [🔠 2.2A – ordre_alpha](../04-laboratoires/Laboratoire%202.2/a-ordre_alpha.md)
- [🥸 2.2B – jolie_liste_lambda](../04-laboratoires/Laboratoire%202.2/b-jolie_liste_lambda.md)
- [🏗️ 2.2C – jolie_liste_builder](../04-laboratoires/Laboratoire%202.2/c-jolie_liste_builder.md)

À la fin du cours, nous comparerons les performances entre la liste avec `lambdas` vs celle avec `ListView.builder`.
:::
