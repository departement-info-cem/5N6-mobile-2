...
- &#8203;<Highlight color="info">2 points</Highlight> Garder les pages de connexion et d'inscription pour la connexion avec Utilisateur/Mot de passe.
- &#8203;<Highlight color="info">2 points</Highlight> Dans l'écran de connexion, ajouter un bouton "Connexion avec Google" qui déclenchera le dialogue de connexion Google et effectuera la connexion.
