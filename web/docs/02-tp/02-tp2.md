...
- &#8203;<Highlight color="tip">1 point</Highlight> **Test notification** qui permet de forcer le serveur à envoyer des notifications immédiatement, avec **`POST /test/notification`**
